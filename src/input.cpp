...
// This function gets called at the beginning of each fram to reset the keys that are no longer relevant
...
// Check if certain key was pressed during a the current frame
