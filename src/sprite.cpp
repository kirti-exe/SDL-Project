        ...
        _y(posY)
{
    ...
    this->_boundingBox = Rectangle(this->_x, this->_y, width * globals::SPRITES_SCALE, height * globals::SPRITES_SCALE);
}
...
void Sprite::draw(Graphics &graphics, int x, int y){
    SDL_Rect destinationRectangle = {
        x, 
        y, 
        static_cast<int> (this->_sourceRect.w * globals::SPRITES_SCALE), 
        static_cast<int> (this->_sourceRect.h * globals::SPRITES_SCALE)
    };
...
void Sprite::update() {
    ...
    this->_sourceRect.w * globals::SPRITES_SCALE, this->_sourceRect.h * globals::SPRITES_SCALE);
}
